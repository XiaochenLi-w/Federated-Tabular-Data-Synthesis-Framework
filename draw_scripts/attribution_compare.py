...
if __name__ == "__main__":
    # ==== 数据路径 ====
    real_path = "./draw_scripts/dataset/insurance_org.csv"
    gen_path_fed  = "./draw_scripts/dataset/insurance_fed_privsyn.csv"
    gen_path_adv  = "./draw_scripts/dataset/insurance_adv_privsyn.csv"
    gen_path_privsyn = "./draw_scripts/dataset/insurance_privsyn.csv"
    ...
    plt.tight_layout()
    plt.show()
    fig.savefig('./draw_scripts/fig/attribute_dist.pdf')