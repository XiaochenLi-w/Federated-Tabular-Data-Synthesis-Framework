...
def main():
    ...
    model_config = "exp/{0}/{1}/config_fed_baseline.toml".format(args.dataset, args.model)
    ...
    if not os.path.exists(model_path):
        raise ValueError(
            "Please train the synthesizer first (scripts/train_fed_baseline_synthesizer.py)"
        )
