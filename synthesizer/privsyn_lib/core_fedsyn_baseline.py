...
import synthesizer.privsyn_lib.fed_anonymizer_baseline as fed_anonymizer_baseline
...
class FedprivSyn_baseline(Synthesizer):
    """
    ...
    def obtain_consistent_marginals(
        ...
        noisy_marginals = fed_anonymizer_baseline.get_distributed_noisy_marginals(
            self.data,
