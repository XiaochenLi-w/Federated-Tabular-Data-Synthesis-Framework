...
import synthesizer.privsyn_lib.fed_anonymizer_adv as fed_anonymizer_adv
...
class FedprivSyn_adv(Synthesizer):
    """
    ...
    def obtain_consistent_marginals(
        ...
        noisy_marginals = fed_anonymizer_adv.get_distributed_noisy_marginals(
            self,
            data_transformer,
            self.data,
