...
import synthesizer.privsyn_lib.fed_anonymizer_adaptive as fed_anonymizer_ada
...
class FedprivSyn_adaptive(Synthesizer):
    """
    ...
    def obtain_consistent_marginals(
        self, priv_marginal_config, priv_split_method, data_transformer
    ) -> Tuple[Marginals, int]:
        """
        ...
        noisy_marginals = fed_anonymizer_ada.get_distributed_noisy_marginals(
            self,
            data_transformer,
            self.data,
    ...
    def train(self, data_transformer):
        """
        ...
        _, num_records = self.obtain_consistent_marginals(
            priv_marginal_config, priv_split_method, data_transformer
        )
