...
def train(args, cuda, seed=0):
    ...
    budget_split = {"noise_to_one_way_marginal": model_params["noise_to_one_way_marginal"] * epsilon, "noise_to_two_way_marginal": model_params["noise_to_two_way_marginal"] * epsilon}
